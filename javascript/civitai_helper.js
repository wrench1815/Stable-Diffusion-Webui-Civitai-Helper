...
const get_new_ch_py_msg = (max_count = 3) =>
...
onUiLoaded(() => {
  ...
  function update_card_for_civitai() {
    ...
    // get component
    let ch_always_display_ckb = gradioApp().querySelector(
      "#ch_always_display_ckb input"
    );
    let ch_show_btn_on_thumb_ckb = gradioApp().querySelector(
    ...
    for (const tab_prefix of tab_prefix_list) {
      ...
      for (const js_model_type of model_type_list) {
        ...
        for (let card of cards) {
          ...
          if (replace_preview_btn) {
            if (replace_preview_btn.innerHTML !== "🖼️") {
              ...
              if (!is_thumb_mode) {
                ...
                replace_preview_btn.style.backgroundImage =
                  btn_thumb_backgroundImage;
              }
            }
          }
          ...
          if (!search_term_node) {
            console.log(
              "can not find search_term node for cards in " + extra_network_id
            );
            continue;
          }
          ...
          if (!is_thumb_mode) {
            ...
            add_trigger_words_node.style.backgroundImage =
              btn_thumb_backgroundImage;
          }
          ...
          if (!is_thumb_mode) {
            ...
            use_preview_prompt_node.style.backgroundImage =
              btn_thumb_backgroundImage;
          }
